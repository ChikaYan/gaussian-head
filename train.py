...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, args):
    ...
    scene = Scene(dataset, gaussians, is_debug=args.is_debug, novel_view=args.novel_view, only_head=args.only_head, shuffle=True)
